...
$execute unless entity @a[scores={pvp.id=$(target_id),pvp.pending_from=0}] run return run tellraw @s [{"text":"[Duel] ","color":"dark_gray"},{"text":"Ce joueur a deja une demande en attente.","color":"red"}]
