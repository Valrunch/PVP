...
# l'extraire en texte.
execute store result storage potatopvp:tmp id int 1 run scoreboard players get @s pvp.id
function potatopvp:menu_send_line_msg with storage potatopvp:tmp
